...
describe User do
  ...
  describe "name rules" do
    ...
    it "should reject names that are too long" do
      longName = "a" * 51
      longNameUser = User.new(@attr.merge(:name => ""))
      longNameUser.should_not be_valid
    end
  end
  
	describe "email rules" do
	...
	describe "password validations" do
		...
		it "should require a password" do
			User.new(@attr.merge(:password => "", :passwordd_confirmation => ""))
				should_not be_valid
		end
		
		it "should require a matching password confirmation" do
			User.new(@attr.merge(:passwordd_confirmation => "invalid"))
				should_not be_valid
		end
